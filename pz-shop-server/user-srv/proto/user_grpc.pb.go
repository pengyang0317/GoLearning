...
func (c *userServiceClient) GetUserList(ctx context.Context, in *GetUserRequest, opts ...grpc.CallOption) (*GetUserResponse, error) {
...
func (c *userServiceClient) GetUserByMobile(ctx context.Context, in *GetUserByMobileRequest, opts ...grpc.CallOption) (*GetUserByMobileResponse, error) {
...
func (UnimplementedUserServiceServer) GetUserList(context.Context, *GetUserRequest) (*GetUserResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetUserList not implemented")
}
func (UnimplementedUserServiceServer) GetUserByMobile(context.Context, *GetUserByMobileRequest) (*GetUserByMobileResponse, error) {
